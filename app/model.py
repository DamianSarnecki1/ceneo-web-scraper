...
class Rewievs:
    ...
    transformations = {
        ...
        "helpful": int,
        "unhelpful": int,
        "content": lambda text: Rewievs.translate(text),
        "pros": lambda text: Rewievs.translate(text),
        "cons": lambda text: Rewievs.translate(text)
    }
    ...
    def scrape_opinions(self):
        ...
        while url:
            ...
            for opinion in opinions:
                opinion_instance = Rewievs(opinion)
